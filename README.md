...
<p align="center">
  <img src="chatbot-demo.gif.gif" alt="DANA Automated Resolution Center chatbot demo" width="850">
</p>
...
## Data
- **Source:** 11,000 Google Play Store reviews of the DANA app (`id.dana`), scraped 1 March to 23 August 2026
...
### Why this data-collection approach
Scraping Google Play reviews via `google-play-scraper` is a well-established method in published Indonesian NLP research, not an improvised shortcut. It underlies numerous peer-reviewed sentiment-analysis studies on Indonesian e-wallets and apps (e.g. comparative SVM studies on GoPay and LinkAja reviews reporting 93 to 95% accuracy, and BERT/SVM studies on other high-traffic Indonesian apps). The results here (93.33% SVM accuracy) land squarely in the range reported across that literature, a useful sanity check that the pipeline and preprocessing were done correctly rather than overfit to this one dataset.
...
## Recommendation
Preprocessing and slang-normalization quality had the single biggest impact on model accuracy, more than model choice itself. For production, a hybrid rule + ML architecture is more stable than a pure ML or pure rule-based system.
